...
public class MarkerMechTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        markerMech = hardwareMap.dcmotor.get("ARM MOTOR NAME 1");
        markerMech = hardwareMap.dcmotor.get("ARM MOTOR NAME 2");
        markerMech = hardwareMap.dcmotor.get("ARM MOTOR NAME 3");
        waitForStart();
